...
public class GameCompletedOverlay {
    ...
    private ButtonMenu quit, credit;
    ...
    private void createButtons() {
        quit = new ButtonMenu(Game.GAME_WIDTH / 2, (int) (270 * Game.SCALE), 2, GameState.MENU);
        credit = new ButtonMenu(Game.GAME_WIDTH / 2, (int) (200 * Game.SCALE), 3, GameState.CREDITS);
    }
    ...
    private boolean isIn(ButtonMenu b, MouseEvent e) {
